...
router.get('/benhnhan/tracuu',async function (req, res, next) {
  res.render('benhnhan/tracuu', { LoaiBenh: await LoaiBenhController.getLoaiBenh()});
});
...
router.get('/phieukhambenh/them',async function (req, res, next) {
  ...
  res.render('phieukhambenh/them', { BenhNhan, LoaiBenh, DonVi, Thuoc, CachDung });
});

router.post('phieukhambenh/them', bodyParser,async function (req, res, next) {
  await BenhNhanController.postPhieuKhamBenh(req, res);
});

//=========================LoaiBenh=============================//

router.get('/loaibenh', async function (req, res, next) {
  res.render('loaibenh/danhsach', { LoaiBenh: await LoaiBenhController.getLoaiBenh()});
});
...
router.get('/loaibenh/sua/:MaLoaiBenh',async function (req, res, next) {
  ...
  res.render('loaibenh/sua', { LoaiBenh });
});
...
router.get('/thuoc', async function (req, res, next) {
  res.render('thuoc/danhsach', { Thuoc: await ThuocController.getThuoc()});
});

router.get('/thuoc/them',async function (req, res, next) {
  res.render('thuoc/them', { DonVi: await DonViController.getDonVi(), CachDung: await CachDungController.getCachDung()});
});
...
router.get('/thuoc/sua/:MaThuoc',async function (req, res, next) {
  ...
  res.render('thuoc/sua', { Thuoc, DonVi: await DonViController.getDonVi(), CachDung: await CachDungController.getCachDung() });
});
...
router.get('/donvi', async function (req, res, next) {
  res.render('donvi/danhsach', { DonVi: await DonViController.getDonVi()});
});
...
router.get('/cachdung', async function (req, res, next) {
  res.render('cachdung/danhsach', { CachDung: await CachDungController.getCachDung()});
});

router.post('/cachdung/them', bodyParser,async function (req, res, next) {
  await CachDungController.postThemCachDung(req, res);s
});
...
router.get('/cachdung/sua/:MaCachDung',async function (req, res, next) {
  ...
  res.render('cachdung/sua', { CachDung });
});
